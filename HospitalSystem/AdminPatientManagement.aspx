...
<head runat="server">
    ...
    <link href="Styles/AdminPatientManagement.css" rel="stylesheet" />
</head>
<body>
    <form id="form1" runat="server">
        <div class="background">
            <div class="container mt-5">
                <h1 class="mb-4 text-white">Patient Management or <a href="AdminPatientList.aspx">Patient List</a></h1>
